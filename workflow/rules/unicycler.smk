...
rule unicycler:
    ...
    output:
        contigs             = OUTPUT_DIR + "{sample}/assembly/unicycler/assembly.fasta"
    message:
        "Run unicycler to assemble trimmed reads"
    conda: 
        "unicycler_env"
    params:
        output_dir          = OUTPUT_DIR + "{sample}/assembly/unicycler/",
...
rule copy_unicycler_to_temp:
    input:
        fasta                   = rules.fix_contigs_unicycler.output.fixed_contigs
    output:
